...
const ApprovalLogPending = () => {
    const [email, setEmail] = useState([]);
    useEffect(() => {
        const getemail = async () => {
            const resemail = await fetch("http://localhost:8000/api/pending");
                    ...
                    <div class="welcome">
                        <div class="content rounded-3 p-2">
                            <div className='approvalbtnposition'>
                                ...
                                <Link to="/approval-log/pending"><button className="button btn2" style={{backgroundColor: "yellow",color: "black"}}>PENDING</button></Link>
...
export default ApprovalLogPending;