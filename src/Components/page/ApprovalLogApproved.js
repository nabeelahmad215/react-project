...
const ApprovalLogApproved = () => {
    const [email, setEmail] = useState([]);
    useEffect(() => {
        const getemail = async () => {
            const resemail = await fetch("http://localhost:8000/api/approved");
                    ...
                    <div class="welcome">
                        <div class="content rounded-3 p-2">
                            ...
                            <Link to="/approval-log"><button className="button btn1" >ALL</button></Link>
                                ...
                                <Link to="/approval-log/approved"><button className="button btn3" style={{backgroundColor: "green",color: "white"}}>APPROVED</button></Link>
...
export default ApprovalLogApproved;